...
async function fetchUserDetails(userId) {
    try {
        ...
        // Use standard fetch here or apiRequest if supported GET
        // But get_user_details.php is in admin root, wait I put it there? 
        // No, I put it in backend/admin/get_user_details.php in my write_to_file tool.
        // But convention is api/admin/get_user_details.php or similar?
        // Wait, "backend/admin/get_user_details.php" is NOT an API path properly if I want to use apiRequest helper which targets /api/admin...
        // But since I wrote it to backend/admin directory, I can access it via relative path 'get_user_details.php'.
