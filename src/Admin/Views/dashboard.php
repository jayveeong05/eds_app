...
<div class="row g-4 mb-4">
    ...
    <!-- Invoices -->
    <div class="col-md-4 col-lg-3">
        <a href="/admin/invoices.php" class="text-decoration-none">
            <div class="card h-100 hover-shadow">
                <div class="card-body text-center py-4">
    ...
    <!-- Promotions -->
    <div class="col-md-4 col-lg-3">
        <a href="/admin/promotions.php" class="text-decoration-none">
            <div class="card h-100 hover-shadow">
                <div class="card-body text-center py-4">
    ...
    <!-- News -->
    <div class="col-md-4 col-lg-3">
        <a href="/admin/news.php" class="text-decoration-none">
            <div class="card h-100 hover-shadow">
                <div class="card-body text-center py-4">
    ...
    <!-- Knowledge Base -->
    <div class="col-md-4 col-lg-3">
        <a href="/admin/knowledge_base.php" class="text-decoration-none">
            <div class="card h-100 hover-shadow">
                <div class="card-body text-center py-4">
    ...
    <!-- Printer Requests -->
    <div class="col-md-4 col-lg-3">
        <a href="/admin/printer_requests.php" class="text-decoration-none">
            <div class="card h-100 hover-shadow">
                <div class="card-body text-center py-4">
    ...
    <!-- Scan QR -->
    <div class="col-md-4 col-lg-3">
        <a href="/admin/scan.php" class="text-decoration-none">
            <div class="card h-100 hover-shadow">
                <div class="card-body text-center py-4">
